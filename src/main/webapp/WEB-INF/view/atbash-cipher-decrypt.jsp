...
<div class="text">
    ...
    <p>Encryption is performed by replacing the first letter of the alphabet with the last, the second with the penultimate.    </p>
    <p>The encryption rule is to replace the i-th letter of the alphabet with a letter number n - i + 1 where n is the number of letters in the alphabet.    </p>
